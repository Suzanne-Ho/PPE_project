...
export default function useNewPost() {
  ...
  const onSubmit = async function (e) {
    ...
    if (data.get('title') && data.get('message') && data.get('subject')) {
      ...
      <form onSubmit={onSubmit}>
        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
          ...
          <div className="sm:col-span-2">
            ...
            <textarea id="description" rows="15" placeholder="Content" type="text" name="message"
        ...
        <div className="flex mt-5 space-x-5">
          <button className="p-6 rounded px-3 py-2 text-neutralText bg-primaryBg hover:bg-onPrimaryBg hover:text-hoverText" onClick={() => (state.button = 1)}>
            Send
          </button>
          <button className="p-6 rounded px-3 py-2 text-neutralText bg-primaryBg hover:bg-onPrimaryBg hover:text-hoverText" onClick={() => (state.button = 0)} >
            Cancel
          </button>
        </div>
      </form>
